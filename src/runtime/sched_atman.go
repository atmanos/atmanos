...
func (r *cpuRegisters) debug() {
	kprintString("cpuRegisters<")
	kprintPointer(unsafe.Pointer(r))
	kprintString("> ")
	kprintString(" r15=")
	kprintPointer(unsafe.Pointer(r.r15))
	kprintString(" r14=")
	kprintPointer(unsafe.Pointer(r.r14))
	kprintString(" r13=")
	kprintPointer(unsafe.Pointer(r.r13))
	kprintString(" r12=")
	kprintPointer(unsafe.Pointer(r.r12))
	kprintString(" rbp=")
	kprintPointer(unsafe.Pointer(r.rbp))
	kprintString(" rbx=")
	kprintPointer(unsafe.Pointer(r.rbx))
	kprintString(" r11=")
	kprintPointer(unsafe.Pointer(r.r11))
	kprintString(" r10=")
	kprintPointer(unsafe.Pointer(r.r10))
	kprintString(" r9=")
	kprintPointer(unsafe.Pointer(r.r9))
	kprintString(" r8=")
	kprintPointer(unsafe.Pointer(r.r8))
	kprintString(" rax=")
	kprintPointer(unsafe.Pointer(r.rax))
	kprintString(" rcx=")
	kprintPointer(unsafe.Pointer(r.rcx))
	kprintString(" rdx=")
	kprintPointer(unsafe.Pointer(r.rdx))
	kprintString(" rsi=")
	kprintPointer(unsafe.Pointer(r.rsi))
	kprintString(" rdi=")
	kprintPointer(unsafe.Pointer(r.rdi))
	kprintString(" code=")
	kprintPointer(unsafe.Pointer(r.code))
	kprintString(" rip=")
	kprintPointer(unsafe.Pointer(r.rip))
	kprintString(" cs=")
	kprintPointer(unsafe.Pointer(r.cs))
	kprintString(" rflags=")
	kprintPointer(unsafe.Pointer(r.rflags))
	kprintString(" rsp=")
	kprintPointer(unsafe.Pointer(r.rsp))
	kprintString(" ss=")
	kprintPointer(unsafe.Pointer(r.ss))
	kprintString(" }\n")
}
